...
INSERT INTO "new_Goal" ("accountId", "amount", "color", "createdAt", "endingDate", "iconRef", "id", "isArchived", "name", "startingDate", "updatedAt", "walletId") SELECT "accountId", "amount", "color", "createdAt", "endingDate", "iconRef", "id", "isArchived", "name", "startingDate", "updatedAt", "walletId" FROM "Goal";
DROP TABLE "Goal";
